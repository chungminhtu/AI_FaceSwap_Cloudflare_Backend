...
| POST `/editor` | **WaveSpeed** Auto-route: Gemini 2.5 Flash Image (< 800px) / Flux Klein v3 (≥ 800px) | `api/v3/google/gemini-2.5-flash-image/edit` or `api/v3/wavespeed-ai/flux-2-klein-9b/edit` | $0.016-$0.038 |
